...
active_dependencies = Gauge(
    ...
    'Total number of active dependencies'
)

pending_dependencies = Gauge(
    'pending_dependencies_total',
    'Number of dependencies waiting to be satisfied'
)

failed_dependencies = Gauge(
    'failed_dependencies_total',
